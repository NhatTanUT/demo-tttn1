...
module.exports = function (passport) {
                ...
                User.findOne({'email': email}, function (err, user) {
                    ...
                    if (user) {
                        ...
                        newUser.save(function (err) {
                            ...
                            return done(null) // không bị trả về trang của user đó nữa
                            // return done(null, newUser); // ban đầu nó trả về trang của user đó
                        });
                    }
                });
            });
    ...
    function (req, email, password, done) { // callback với email và password từ html form
        ...
        User.findOne({'email': email}, function (err, user) {
            ...
            if (!user)
                return done(null, false, {message: 'No found userId'});
