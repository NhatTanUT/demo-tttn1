...
route.post('/product', AdminController.updateProduct)
route.post('/category', AdminController.updateCategory)
// route.post('/removeProduct', AdminController.removeProduct)
// route.post('/removeCategory', AdminController.removeCategory)
